...
export async function createValidator(root = process.cwd()): Promise<InstanceType<typeof Ajv.default>> {
  ...
  for (const name of ['rights', 'evidence', 'reference-run', 'reference-profile', 'design-principle', 'analysis-packet', 'project-brief', 'reference-set', 'synthesis-packet', 'synthesis-map', 'creative-packet', 'creative-concepts', 'concept-review', 'human-creative-gate', 'human-concept-decision', 'implementation-contract']) {
